...
define( 'MTL_IMAGES_URI', '/wp-content/plugins/maxtradelogin/images' );
define( 'MTL_CSS_URI', '/wp-content/plugins/maxtradelogin/css' );
define( 'MTL_JS_URI', '/wp-content/plugins/maxtradelogin/js' );
